...
import lab.anubis.saasmultitenantapp.mapper.ProductMapper;
...
import lab.anubis.saasmultitenantapp.services.ProductService;
...
public class ProductServiceImpl implements ProductService {
    ...
    public List<ProductResponse> findAllList() {
        return this.productRepository.findAll().stream()
                .map(this.productMapper::toResponse).toList();
    }
